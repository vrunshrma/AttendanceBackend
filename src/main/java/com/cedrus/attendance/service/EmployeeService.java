...
import com.cedrus.attendance.repository.EmployeeRepository;
	...
	EmployeeRepository employeerepository;
	 ...
	 public String addUser(EmployeeDetail employeedetail) {
	    ...
	    public EmployeeDetail findByempid(String employeeid,String shift) {
		 EmployeeDetail employee = (EmployeeDetail) employeerepository.findByEmployeeIdAndShiftType(employeeid,shift);
